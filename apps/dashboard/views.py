...
EXPORT_MAP = {
    ...
    'providers': ('providers.csv', ['id','user__username','display_name','status','verification_status','created_at']),
...
def providers_list(request):
    ...
    qs=_search(qs,request.GET.get('q'),['user__username','user__email','display_name','phone'])
...
def verification_list(request):
    ...
    qs=_search(qs,request.GET.get('q'),['provider__user__username','provider__user__email','provider__display_name'])
